...
if(isset($_POST['submit']) || isset($_POST['signup'])) {
    ...
    if($user == "" || $pass == "") {
        ...
        $result = mysqli_query($db, "SELECT * FROM user WHERE username='$user' AND password=md5('$pass') AND category='$role'")
        ...
        if(is_array($row) && !empty($row)) {
            ...
            elseif (isset($_POST['signup'])) {
              ...
              $regiter=mysqli_query($db,"INSERT INTO user (username,password,category) VALUES('$user',md5('$pass'),'$role')")
              or die("Could not execute the selected query.");
              if($regiter){
...
<body class="login-body">
    ...
    <form class="form-signin" method="post">
      ...
      <img class="mb-4" src="psu.png" alt="" width="150" height="150">
